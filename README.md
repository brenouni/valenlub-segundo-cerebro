...
Financeiro: contexto, decisões e pendências para Hermes e Grok Bot. Query primeiro. Sinaliza sem baixar. Rascunho de inadimplência 08h.

- **Este repo** = fonte versionada (Trilha 3).
- **Notion GoFluxo OS** = operacional da Fase 1.
- Chat não é memória.
- Sem senha, token, CPF ou extrato cru.
